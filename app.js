...
var incompleteTaskHolder=document.querySelector(".tasks__incomplete-tasks");//ul of #incomplete-tasks
var completedTasksHolder=document.querySelector(".tasks__completed-tasks");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className = "tasks__img-remove";
